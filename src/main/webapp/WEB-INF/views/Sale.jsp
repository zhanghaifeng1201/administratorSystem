		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-9">
					...
					<form role="form" action="insertOneOutSale" method="post" onsubmit="return dosubmit();">
						...
						<div class="form-group">
									<label>价格</label><br/>
									<select id="select"  class="form-control" onchange="change(this)" style="float:right ;width: 15%">
										<option id="priceone" value="1">参考零售价</option>
										<option id="pricetow" value="2">参考批发价</option>
									</select>
									<input id="datashow" class="form-control" name="out_price" type="number" step="0.01" value="" style="float:left ; width: 85%">
						...
						<div class="form-group">
							<label>数量</label>
							<input type="number" step="0.01"  class="form-control" id="number" name="out_number" min="0" placeholder="数量">
						</div>
						<div class="form-group">
							<label>客户</label>
							<input type="text" class="form-control" id="client" name="client"  placeholder="客户">
						</div>
						<div class="form-group">
							<label>单位</label>
							<input type="text" class="form-control" id="unit" name="out_unit" placeholder="单位">
						</div>
						<div class="form-group">
							<label>备注</label>
							<textarea type="text" class="form-control" id="remarks" name="out_des" placeholder="备注" rows="8" cols="18"></textarea>
						</div>

						<button id="output" class="btn btn-default" type="submit">出库</button>
					</form>
				</div>
			</div>
		</div>
